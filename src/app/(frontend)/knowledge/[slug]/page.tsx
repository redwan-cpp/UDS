...
export async function generateMetadata({
  ...
  // headline rather than as a bare domain.
    ...
    <article>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            articleJsonLd(item, { path: "/knowledge", label: "Knowledge" }),
          ).replace(/</g, "\\u003c"),
        }}
      />
      ...
      <Section surface="light" spacing="standard">
        <Container width="text" className="mx-auto">
          ...
          {/* At the end of the read, not the top: nobody shares an article
              they have not finished. */}
          <Reveal>
            <div className="mt-14 max-w-[54ch]">
