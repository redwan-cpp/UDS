...
// Most collections are shared studio records. Keep this re-export here so
// their existing field imports continue to read as one contract.
export { publishedOnlyAccess } from "./access";
